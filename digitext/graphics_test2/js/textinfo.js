const textInfotoJSON =
[
    {
        "id":"002",
        "content":"Mama ist auf der Couch eingeschlafen, Papa hat sie zugedeckt. Jetzt steht er in der Küche und winkt uns zu sich. Er hat zwei dünne Scheiben von einer Gurke abgeschnitten und flüstert uns zu, wir sollen sie auf Mamas Augen legen. Yannis und ich schauen uns an und nicken. Wir trippeln zu dritt zur Couch. Kurz bevor wir die Gurkenscheiben platzieren, meine Hand zittert ein bisschen, prustet Papa los und Mama wacht auf.",
        "pos":{"x":16, "y": 18},
    },
    {
        "id":"003",
        "content":"\"Im Namen des Vaters, des Sohnes und des heiligen Geistes - Amen\", beginnt der Priester die frühmorgendliche Ostermesse. Mir ist schlecht. Ich flüstere Mama zu, dass mir schlecht ist. Sie flüstert ich solle nicht versuchen mich rauszureden, mich generell nicht so anstellen und könne doch mal was ihr zu Liebe tun. Mir ist richtig doll schlecht. Ich weiß, dass mein Magen sich gleich nach außen stülpen wird und dann auch keine Ave Maria mehr hilft. Ich springe auf und renne den langen Kirchenflur entlang, bis ich wieder Sonne in meinem Gesicht spüre. Dann kotze ich an die Kirchenwand.",
        "pos":{"x":24, "y": 19},
    },
    {
        "id":"004",
        "content":"An einem Sonntagmorgen im April, drei Tage vor Mamas Geburtstag, da weiß ich, dass mein Leben vorbei ist. Ich wache auf und habe eine neue Whatsapp Nachricht von Papa auf dem Handy: Ein Foto von einem Minion, darunter in knallroten Buchstaben: BANANA.",
        "pos":{"x":26, "y": 19.5},
    },
    {
        "id":"005",
        "content":"\"Frag mal Papa welchen Salatkopf du schon abschneiden kannst, da weiß ich immer nicht so genau. Ach und kannst du auch noch ein bisschen Petersilie mitbringen? So fünf Stängel müssten reichen.\"",
        "pos":{"x":27.5, "y": 20},
    },
    {
        "id":"006",
        "content":"Auf dem Weg nach Hause zieht Yannis einen weißen Umschlag aus dem Schulranzen und steckt ihn sich unter den Pullover. Sehr offensichtlich. Ich habs gesehen, Papa hats gesehen, der ganze Bus hats gesehen.\n\"Was hast du denn da, Yannis?\" Papa beugt sich in unserem Vierersitz vor und kneift Yannis in den Oberschenkel.\n\"Wo?\" Yannis hält sich die Hand über die Ausbeulung an seinem Pulli.\n\"An deinem Bauch da?\"\n\"Bauchweh.\"\n\"Yannis?\" Papa hebt die Augenbrauen. \"Hast du Radau gemacht? Wieder was mit diesem Kai Mühlbecker?\"\nYannis schüttelt den Kopf.\n\"Yannis?\"\n\"Ich erzähls später Mama, wirklich.\"\n\"Warum erzählst du's mir nicht jetzt?\"\nYannis sieht flehend zu mir.\n\"Wir haben heute in Physik ganz viel über Züge geredet\", beginne ich, aber Papa wedelt mein Ablenkungsmanöver mit der Hand weg.\n\"Yannis, du kannst mir alles erzählen, das weißt du doch, Großer. Was hast du da unter deinem Pulli?\"\nYannis hält einen Moment die Luft an und ist ganz still, dann akzeptiert er sein Schicksal. Er blick starr auf seine Füße, während er den Elternbrief hervorzieht und Papa in die Hand drückt. Papa zieht einen Zettel aus dem Couvert und liest.\n\"Ah ja\", sagt er langsam, die Augen huschen über das Papier. \"Da werd ich aber mal eine Mail schreiben, du. Das lassen wir doch nicht einfach so mit uns machen, oder, Großer?\"\nYannis starrt auf seine Schuhe und nickt.",
        "pos":{"x":18, "y": 20},
    },
    {
        "id":"007",
        "content":"Mama schenkt mir ein Fotoalbum, in dem das erste Bild sie und Papa im Frankreich-Urlaub zeigt, in Badeklamotten, Arm in Arm vor einem kleinen Zelt. Ein Pfeil deutet auf Mamas nackten Bauch. Daneben steht: \"Dein erster Tag auf dieser Welt.\" Papa war richtig beleidigt, weil ihm der Witz nicht eingefallen ist.",
        "pos":{"x":20.5, "y": 21.2},
    },
    {
        "id":"008",
        "content":"Ich puste die Geburtstagskerzen aus und öffne mein Geschenk. Es ist ein Buch.\nYannis grinst und lehnt sich über den Tisch.\n\"Wenn wir Omas ganzes Geld nicht einfach weggeschenkt hätten, dann hättest du jetzt ein echtes BMX!\"\nPapa hustet Kuchenkrümel auf den Tisch, Mama packt Yannis am Handgelenk und sagt ruhig, ganz ruhig: \"So etwas, Yannis Sewering, sagst du nie wieder.\"",
        "pos":{"x":23.5, "y": 21.5},
    },
    {
        "id":"009",
        "content":"Ich schaue Werder gegen Stuttgart, es läuft die einundvierzigste Minute und Papa steht schon seit der zwanzigsten draußen auf der Veranda. Ich springe vom Sofa auf, renne zur Tür, reiße sie auf: \"Papa, Elfer für Werder!\" \nPapa wedelt mit der Hand und murmelt: \"Jetzt nicht.\"",
        "pos":{"x":27, "y": 22},
    },
    {
        "id":"010",
        "content":"Als auch nach einer Stunde keiner das letzte Nackensteak mehr will, trägt Mama die soßenverschmierten Teller in die Küche und kommt mit einer Packung Zigaretten wieder. Sie raucht nur selten, nur im Sommer, nur nach zu viel Wein. Yannis und ich bemerken, wie sich Papas verschwitzte Stirn in Falten legt, als er die Schachtel erblickt.",
        "pos":{"x":25, "y": 23.5},
    },
    {
        "id":"011",
        "content":"Oma hat fast ihr ganzes Leben in einem kleinen weißen Bungalow verbracht, und obwohl sie nie viel Geld hatte, konnte sie irgendwann das flache Haus in der Mommensstraße ganz offiziell, mit Grundbucheintrag und allem drum und dran, ihr eigen nennen. Nachdem Oma gestorben ist, haben Mama und Papa den Bungalow direkt verkauft.\nMorgen ist die Übergabe und wir sitzen alle auf der Terrasse und grillen Maiskolben. Es ist wohl das letzte Mal, dass wir den kleinen weißen Bungalow sehen werden, denn die neuen Eigentümer reissen ihn direkt ab. Das Geld wollen Mama und Papa spenden. Bis auf den letzten Cent. Sie wollen nicht das Garagentor reparieren lassen und auch nicht mit uns in den Urlaub fahren. Papa meint es wäre nicht unser Geld.",
        "pos":{"x":22, "y": 24},
    },
{
        "id":"012",
...
{
        "id":"015",
        "content":"Auf Omas Beerdigung sitze ich in der zweiten Reihe neben Yannis und neben Yannis meine coole Tante. Ich finde es ein wenig unfair, dass wir nur in der zweiten Reihe sitzen und der Pastor in der ersten, aber meine coole Tante sagt, es gäbe manchmal Dinge auf der Welt, die könne man nicht ändern und die Länge der Bank in der kleinen Kapelle sei nunmal eine davon. Yannis weint ganz bitterlich - ich gebe ihm ein Taschentuch und drücke meine Schulter ganz doll gegen seine, weil es mir peinlich wäre, seine Hand zu halten. Als sie das Udo Jürgens Lied spielen weint auch Papa ganz bitterlich und ich bin froh, dass ich mich um Yannis kümmern kann, weil Papa nie weint und sich das falsch anfühlt. Als wir später am Grab stehen legt Mama ihren Arm um Papa und streicht ihm über den Kopf. Das werde ich nie vergessen, weil es sonst immer andersrum war. Und dann fängt es ein kleines bisschen an zu regnen.",
        "pos":{"x":21, "y": 26.5},
    },
{
        "id":"016",
        "content":"\"Mein Papa hat immer gesagt, dass ein echter Mann nicht heult\", sagt mein Papa, \"Was natürlicher totaler Unsinn ist.\"\n\"Und das beweist dein Vater immer und immer wieder\", sagt Mama als sie hinzukommt und mir einen Arm um die Schulter legt. Wir lachen beide. \"Ich hab nur Heuschnupfen\", sage ich und reibe mir die Augen.\n\"Man muss sich nicht für seine Gefühle schämen\", fängt Papa wieder an. \"Ganz im Gegenteil. Es ist sogar total wichtig hin und wieder mal alles rauszulassen\", ergänzt Mama. Ich rolle mit den Augen und gehe mir ein Taschentuch holen. Ich hab nämlich wirklich nur Heuschnupfen. ",
        "pos":{"x":25, "y": 27},
    },
{
        "id":"017",
        "content":"Als wir das erste Mal hier waren, durfte ich mir eine Cola bestellen, habe schüsselweise Salzbrezelchen gegessen und Deutschland hat im Elfmeterschießen gegen die Niederlande verloren. Jetzt steht ein Helles vor mir, ich kenne den Barkeeper beim ganzen Namen und alle außer Papa springen beim 2:0 gegen Belgien auf. Ich high-five Kalle \"Werner\" Richter, er stellt Papa noch ein Bier hin und Papa nickt, ohne von seinem Handy aufzugucken. ",
        "pos":{"x":24.5, "y": 29},
    },
{
        "id":"018",
        "content":"\"Dein Kuchen schmeckt schrecklich, Andrea\", sagt Opa mit breitem Grinsen im Gesicht und stupst Mama mit dem Ellbogen an. \"Unser Gerdi hat was besseres verdient.\"\nMama lacht und lädt ihm noch ein extra-großes Stück auf den Teller.\"Und ihr seid ganz schöne Giftzwerge, ihr beiden.\" ",
        "pos":{"x":18.5, "y": 28},
    },
{
        "id":"019",
        "content":"Wir sitzen am Esstisch. Yannis spielt Clash Royale auf seinem Handy und aus irgendeinem Grund interessiert es Mama und Papa nicht. Sie sind den ganzen Tag schon komisch drauf. Sie feiern heute Hochzeitstag, den 14. oder vielleicht auch den 17., ich habe nicht so genau zugehört. Für die beiden gab es schon zum Frühstück Sekt und seitdem ist alles seltsam. In der Schule musste ich feststellen, dass in meiner Brotbox nur ein 2-Euro- Stück anstatt etwas zu Essen lag. In der Mittagspause hat Papa angerufen und mich atemlos gefragt, bis wann ich denn heute nochmal Schule hätte. Jetzt sitzen die beiden am Essenstisch und füßeln was das Zeug hält. Ständig stößt Mama gegen mein Schienbein, gluckst und macht einfach weiter. Papa öffnet das Senfglas mit einem übertriebenen Ruck und guckt heldenhaft.\nMama lacht und sagt: \"Oh, starker Mann\".\nPapa mit Piratenstimme: \"Jaja, heute mach ich dir den Ranger Berry\" Er zwinkert.\n\"Ey, ich erzähl dir nie wieder sowas\", sagt Mama und wirft ein paar Erbsen nach ihm.\nIch vermute, dass hier alle bekloppt geworden sind und gehe auf mein Zimmer. Niemand ruft mir nach. ",
        "pos":{"x":27, "y": 31},
    },
{
        "id":"020",
        "content":"Wir sitzen vor dem Fernseher und schauen eine Dokumentation über Skandinavien. Gerade ist ein Bär zu sehen, der einen Lachs in Stücke reißt. Yannis schaut kurz hoch und sagt: \"Bäh\", dann schiebt er das Polizeiauto weiter auf dem Teppich herum.\nSpäter zeigen sie die Polarlichter am Nordkapp. Papa kann gar nicht genug kriegen, sitzt ganz aufrecht und macht ganz große Augen. Er macht den Mund auf und wieder zu und wieder auf. Dann sagt er ganz langsam: \"Das würde ich wirklich gerne einmal sehen. Das muss pure Magie sein.\" Mama lächelt. Er dreht sich zu ihr und meint: \"Nein im Ernst. Das wär doch was: Wir alle zum Nordkap. Roadtrip, sag ich nur. Wer hat Lust?\"\n\"Ich, ich, ich\", sagt Yannis, obwohl er gar nicht weiß worum es geht. \"Das wär schon ziemlich cool\", sage ich und nicke. Papa stupst Mama an, damit sie von ihrem Handy hochschaut. \"Na?\", fragt er, \"nächsten Winter Skandinavien?\" Sie braucht einen Moment um zu begreifen, warum alle zu ihr gucken und sagt dann: \"Ich glaube, das ist eher was für meine drei taffen Männer. Ihr wisst doch, dass ich so eine Frostbeule bin. Ich würde euch doch nur auf die Nerven gehen und mich ständig über die Kälte beschweren. Aber fahrt ihr doch ruhig zu dritt nächsten Winter.\" Papa schaut komisch. Dann schiebt sie noch hinterher: \"Ich warte dann hier mit einem heißen Kakao auf euch\" und lacht. ",
        "pos":{"x":16, "y": 27.5},
    },
{
        "id":"021",
        "content":"\"Danke\", sagt Yannis ins Mikrofon, und \"danke\", hallt sein sanftes Stimmlein durch die Aula, durch die gesamte Schule, erwidert von ohrenbetäubendem Applaus. Papa steht auf, eine Träne im Augenwinkel, seine Lippen formen lautlos im verzerrten Rauschen um uns herum: Das ist Yannis! Das ist mein Yannis! ",
        "pos":{"x":18, "y": 3},
    },
{
        "id":"022",
        "content":"Es sind die nicht Fotos oder das alte Spielzeug, das Papa zum Weinen bringt. Es sind die Rezepthefte im Küchenschrank. Die Zutaten für ein vernünftiges Gulasch in Omas feiner Schreibschrift, bestimmt 30 Jahre alt, treiben ihm die Tränen in die Augen. Wortlos geht er aus der stillen Küche, vorbei am kalten Herd. Mama schaut ihm nach und reicht mir einen ganzen Wäschekorb mit Rezepten. Bring das mal zur Papiertonne und frag Papa, ob er dir hilft. Was zu tun haben, meint sie, das sei jetzt das wichtigste. ",
        "pos":{"x":20.5, "y": 30.5},
    },
{
        "id":"023",
...
{
        "id":"025",
        "content":"\"Und der hier, der heißt Har Arbel, das ist nur eine kleine Wanderung vom Hotel und es gibt eine schöne Burg zum Draufklettern für die Jungs\", sagt Papa hinter der Landkarte. Mama steckt sich eine Gabel Tomatensalat in den Mund.\n\"Was sagt ihr? Burg? Na?\"\nYannis bläst genervt die Acnebacken auf und zu. Ich zucke die Achseln.\n\"Na wenn das mal nicht ein eindeutiges Ja ist! Andrea?\"\nPapa schaut zu Mama, die zeigt auf ihren vollen Mund, kaut, kaut, schluckt, schiebt sich noch eine Gabel in den Mund.\n\"Also wirklich jetzt. Hätten wir ja auch einfach zu Hause bleiben können. Nee, nächstes Mal fahr ich einfach allein.\"\n\"Gute Idee\", sagt Yannis. Mama lacht mit vollem Mund. ",
        "pos":{"x":15, "y": 33},
    },
{
        "id":"026",
        "content":"Ich halte die Klinke runtergedrückt, während ich die Wohnungstür ganz langsam, Zentimeter für Zentimeter hinter mir zuziehe. Sie fällt mit einem klitzekleinen Putziwutzi-Klicken ins Schloss, so leise, das nicht mal James Bond es hören könnte. Ich würde mich selbst high fiven, aber das wäre zu laut. Auf Zehenspitzen schleiche über die nicht knarrenden Dielen den Flur entlang, was gar nicht so einfach ist, wenn der ganze Flur sich dreht und der Boden sich wölbt und das letzte Bier ist immer schlecht.\nIn der Küche brennt Licht. Papas Rücken, unbewegt auf einem Stuhl, den Kopf auf etwas in seiner Hand gerichtet. Fuck. Shit. Was würde James Bond tun?\n\"Für Queen und Mutter England!\", verkünde ich, während die Küchentür an mir vorbeitaumelt.\nPapas Rücken zuckt zusammen, die Arme verschränken sich vor der Brust zu einer lustigen Brezel.\n\"Das ist aber eine Uhrzeit, junger Mann\", sagt er.\n\"Fürwahr, alter Mann, fürwahr\", sage ich, und trinke ein paar Schlücke kaltes, klares, reines Bergwasser direkt aus dem Wasserhahn.\n\"Was haben wir nur bei deiner Erziehung falsch gemacht?\", fragt Papa und steht auf.\n\"Was machst du noch wach?\", gebe ich zwischen zwei Schlücken zurück.\nEr schüttelt den Kopf und verlässt den Raum. Aus seiner Hand ragt ein kleines Stück welliges Papier, an den Rändern rot angemalt. ",
        "pos":{"x":24.5, "y": 33},
    },
{
        "id":"027",
...
{
        "id":"028",
        "content":"Unser letzter gemeinsamer Sommerurlaub nach Amrum ist auf der A7 schon fast vorbei, weil ich nicht den Ölstand überprüft habe. Meint Papa jedenfalls. Ich sei der Fahrer und der müsse vorher prüfen, wie der Ölstand sei. Die Motorhaube dampft und ich auch. Yannis mault, er hätte sowieso kein Bock auf das Scheiß Meer und Mama meint, Yannis solle nicht so viel Scheiße sagen und dass Papa aufhören so einen Scheiß zu erzählen und dass man seinen 17 jährigen Sohn nicht dafür verantwortlich machen könne, dass sein Vater so eine Schrottkarre fährt. Dann dampft auch Papa, steigt aus. Ich soll mit aussteigen, weil sowas bekommt man ja in der Fahrschule nicht beigebracht. Er freut sich fast ein bisschen beugt sich über den Motor, sagt: \"Sooo…\"\nEine halbe Stunde später stehe ich neben Yannis auf dem stinkenden Parkplatz. Die Autos rasen vorbei, mein Bruder sucht nach Empfang und ich schaue Mama dabei zu, wie sie die Karre zum Laufen bringt. Sie lächelt mir zu und schmiert sich die dreckigen Hände an der neuen Jeans sauber. Papa sitzt derweil auf eine Parkbank, ignoriert uns drei und beißt beleidigt in ein Käsebrot. ",
        "pos":{"x":20, "y": 2},
    },
{
        "id":"029",
        "content":"Papa drückt allen ein Weidenkörbchen in die Hand. Mama bekommt das kleinste, Yannis das Mittlere, Ich das Große und Papa nimmt sich den 20 Liter Putzeimer. \"Auf die Plätze, fertig, los\", brüllt er und reißt die Tür zum Garten auf. Ich sprinte los, Yannis tritt mir auf die Ferse, aber ich falle nicht. Ruckzuck bin ich zwischen den Himbeerbüschen und pflücke, was das Zeug hält. Neben mir singt Papa lautstark: \"Eine ins Töpfchen und eine ins Kröpfchen!\" Dabei werfen sich Mama und er gegenseitig Himbeeren in den Mund. Yannis drängelt sich an mir vorbei und entlädt sein schon volles Körbchen in Papas Eimer. Ich schaue auf meine Ausbeute und frage mich, warum ich jedes Jahr der Langsamste bin.",
        "pos":{"x":16, "y": 3.2},
    },
{
        "id":"030",
        "content":"Mama sitzt schon fast eine Stunde vor einer halb zusammengepuzzelten Welle, ohne, dass die Welle größer geworden ist. Als ich nach zwei Minuten ein passendes Teil finde, wirft sie die Arme nach oben und ruft: \"Gut, dass ich dich geboren hab.\" ",
        "pos":{"x":22.5, "y": 3.5},
    },
{
        "id":"031",
        "content":"Bevor Mama zur Arbeit fährt, geht sie Joggen. Jeden Morgen um sieben schlüpft sie in ihre Turnschuhe, zieht sich das pinke Stirnband, dass ich ihr vor vielen Jahren einmal im Handarbeitsunterricht gehäkelt habe, über die Ohren und rennt durch den Wald. Irgendwann habe ich sie mal gefragt, warum sie nicht mit Papa zusammen Joggen geht. Sie hat gesagt \"Dein Papa ist nicht so ein Frühaufsteher, das weißt du doch\", und das stimmt auch.\nVielleicht ist das noch nicht die ganze Wahrheit. Einmal war ich mit Papa Joggen, und es war die absolute Hölle. Papa geht am liebsten mittags laufen, als kleines Päuschen, wenn schon einiges erledigt ist. Er läuft aber nicht durch den Wald, sondern mitten durchs Dorf. Dabei trägt er seine total kaputtgelatschten Chucks und eine hautenge Laufhose. Er kann an keinem Vorgarten vorbeilaufen, ohne der Person darin zu winken oder ein paar Grüße über den Zaun zu rufen. Wenn er jemanden trifft, den er tatsächlich kennt, bleibt er auch gerne mal stehen und lässt sich in ein kleines Gesprächlein verwickeln. Das Gesprächlein beginnt er immer mit dem gleichen Dorf-Witz: \"Mensch, du auch hier, was ein Zufall!\" Dann lacht er viel zu laut und wischt sich mit dem T-Shirt den Schweiß aus dem Gesicht.\nWie gesagt: Horror. ",
        "pos":{"x":20.2, "y": 4.9},
    },
{
        "id":"032",
...
{
        "id":"035",
        "content":"Beschreibe dich in einem Satz, steht oben auf der Seite und dann ist dafür die halbe Seite frei. Eigentlich würde ich entweder direkt umkippen oder versuchen, einen so langen Satz zu schreiben, dass er die ganze halbe Seite ausfüllt, aber in Französisch ist mir das egal. Also schreibe ich: Je suis une ordinateur. Den Satz hab ich von Papa, den hat er mir gestern noch zugeflüstert, als ich ihn gefragt hab, was ich bei der Frage hinschreiben soll. Ich wusste, dass die Frage kommt, weil es Herr Ulrich in der letzten Stunde schon verraten hat. Ich lese den Satz nicht mal Probe. Die Note ist sowieso egal, Herr Ulrich ist nämlich ein bisschen verwirrt glauben wir, jedenfalls bemerkt er nicht, wenn wir die Unterschriften auf den Klassenarbeiten fälschen.",
        "pos":{"x":22, "y": 7.3},
    },
{
        "id":"036",
        "content":"Ich ziehe mir den Pulli über den Kopf, nehme die tropfende Badehose von der Bank und trete aus der Umkleidekabine. Papa steht vor den Spiegeln und föhnt Yannis die Haare. Wenn Yannis nicht aufpasst, dreht Papa den Föhn ein paar Grad nach unten und bläst ihm die warme Luft ins Gesicht. Yannis kichert und schlägt den Föhn weg.\nAls wir durch das Drehkreuz nach draußen treten, sitzt Mama auf einer Bank und lächelt uns entgegen. An den Enden glitzern ihre Haare dunkelroter als sonst. Yannis läuft zu ihr und springt auf den Sitzplatz neben ihr.\n\"Ich hab heute Papas Haare geföhnt\", ruft er. \"Siehst du?\"\nEr zeigt auf Papas komplett nassen Haare.\n\"Na\", sagt Papa und setzt sich neben die beiden. \"Neidisch?\"\nMama lächelt. \"Naja.\"",
        "pos":{"x":15, "y": 8},
    },
{
        "id":"037",
...
{
        "id":"038",
        "content":"Mitten in der Nacht wache ich auf und habe furchtbaren Durst. Als ich in Richtung Küche tapse, um mir ein Glas Wasser zu holen, sehe ich Mama und Papa vor dem Fernseher im Wohnzimmer sitzen, beide im Bademantel. Zuerst bemerken sie mich gar nicht, erst nach ein paar Minuten schaut Mama hoch und fragt mich, ob ich auch eine Tasse Tee haben will. ",
        "pos":{"x":25.8, "y": 9},
    },
{
        "id":"039",
...
{
        "id":"042",
        "content":"Weil Mama früher nach Hause kommt, liest sie uns das nächste Kapitel aus der Unendlichen Geschichte vor. Wenn Mama etwas anders ausspricht als Papa, versuchen Yannis und ich es ihr beizubringen. Es geht gerade um einen Tiger mit ganz langem und komplizierten Namen, der seine Farbe ändert wie ein Chamäleon und nachts zu Stein wird. Mama hat eine schöne Vorlesestimme, finde ich, wie die in den Nachrichten. Das macht mich ganz müde, ich fühle mich wie der Löwe aus der Geschichte. Yannis schläft sicher schon und morgen muss ich ihm beim Frühstück erzählen, was passiert ist. \nEs raschelt, ich höre von ganz weit weg, wie Mama vom Bett aufsteht. Mit ganz leiser Stimme sagt sie: \"Wollt ihr noch ein Geschwisterchen, Jungs?\". Aber ich bin schon viel zu müde, um zu antworten. ",
        "pos":{"x":21.9, "y": 11.9},
    },
{
        "id":"043",
        "content":"Nachdem wir uns vor ein paar Tagen einen Weihnachtsbaum ausgesucht haben, stellen wir ihn heute auf. Als Papa den Baum in einem großen Topf mit Steinen fixiert hat, geht er zur Musikanlage und spielt die Weihnachts-CD von Frank Sinatra ab. Ich sehe, wie Mama lächelt, während sie eine durchsichtige Glaskugel an den Baum hängt. Yannis und ich dürfen die unteren Äste mit bunten Holzfiguren schmücken – Nussknacker, Pferde, Sterne, Glöckchen, Engel, Pinguine, Tannenbäume, und noch ganz viele andere Sachen. ",
        "pos":{"x":14.2, "y": 12.1},
    },
{
        "id":"044",
        "content":"\"Ersatzreifen heißt Ersatzreifen, weil? Weil? Na?\"\nPapa in der Pampa. Mama am Kabeltelefon im Rangerbüro. Yannis und ich auf der Parkbank, neben uns Bobo der Parkhund und Ranger Berry, der uns etwas auf Englisch erzählt und nett nickt, also nicke ich auch nett, weil Ranger Berry dann weiterredet und ich Bobo den Parkhund weiterstreicheln kann.\n\"Und wie kommen wir dann hier weg?\", kommt Mamas Stimme aus dem Büro.\nRanger Berry deutet mit dem Kinn Richtung unserer Mutter und zieht die Augenbrauen hoch. Ich nicke nett, weil ich dann Bobo weiterstreicheln kann.\n\"Das war vor zwei Stunden!\", ruft Mama. \"Ja was soll ich denn da machen? Was kann ich denn machen, Gerd?\"\nBobo der Parkhund hebt den Kopf.\n\"Nein, sie sind draußen. Ich weiß. Wir reden später drüber. Was weiß ich denn, müssen wir halt den nächsten Bus nehmen. Wir sehen uns im Hotel.\"\nEin lautes Klicken. Mama kommt aus dem Büro, ein bisschen rot im Gesicht. Vielleicht Sonnenbrand, vielleicht die Hitze. ",
        "pos":{"x":17.5, "y": 12.2},
    },
{
        "id":"045",
        "content":"Einmal, da war Papa so wütend auf einen Film, dass er die DVD aus dem Laufwerk genommen, sie in der Mitte (mit sichtlicher Anstrengung) durchgebrochen hat und direkt zum Recyclinghof gefahren ist, um sie ordnungsgemäß zu entsorgen. ",
        "pos":{"x":25.5, "y": 13.9},
    },
{
        "id":"046",
        "content":"Mama putzt die Fenster in der Küche, Papa recht das Herbstlaub im Garten zusammen. Als ich eine halbe Stunde später wieder in die Küche komme, putzt Papa die Fenster und Mama recht draußen das Herbstlaub zusammen. ",
        "pos":{"x":26.6, "y": 13.1},
    },
{
        "id":"047",
...
{
        "id":"048",
        "content":"\"Findest du das witzig?\", fragt Mama und hält Papa den Zettel unter die Nase. Sie klingt als würde sie ein Schreien unterdrücken. \"Ist es das was du dir unter der Bildung unserer Kinder vorstellst?\"\nSie wedelt mit dem Zettel, als würde dadurch irgendetwas klarer werden. Papa kapiert zumindest nichts. Nachdem ich ihr die Schulaufgabe zum Unterschreiben vorgelegt habe, hat sie geseufzt und mich viel zu lange angesehen. Dann hat sie angefangen zu lesen. Als sie am Anfang der zweiten Seite angekommen ist, war sie dann plötzlich nicht mehr am Seufzen, sondern richtig angepisst. Sie hat mich am Handgelenk genommen und ist mit mir die Treppe hoch in Papas Arbeitszimmer gestapft. Seit ungefähr sieben Minuten stehe ich jetzt hier an den Türrahmen gelehnt und höre den beiden beim Erwachsenen-Diskutieren zu. \n\"Mein Gott\", ruft Papa und fährt sich durch die Haare, \"es ist Französisch siebte Klasse. Da kann man sich ja wohl mal einen Witz erlauben.\"\n\"Es ist aber nicht deine Aufgabe als Erziehungsverantwortlicher deinem Sohn Witze vorzubrabbeln! Vor allem nicht, wenn der sie dann in seine Schulaufgabe schreibt und deswegen von Herrn Ulrich eine vier minus bekommt, weil der fand das nämlich nicht so witzig, sondern kam sich – zurecht, wie ich finde – verarscht vor.\"\n\"Andrea, jetzt hör doch mal auf…\"\nIch quetsche mich um den Türrahmen herum in den Flur, klopfe leise an Yannis Tür und frage, ob er Lust hat was zu spielen. ",
        "pos":{"x":14.9, "y": 14.2},
    },
{
        "id":"049",
...
{
        "id":"052",
        "content":"\"Nicht anfassen!\", ruft Mama, als Frau Harrensen sich zum Blumenbeet hinunterbückt. \"Auf gar keinen Fall anfassen! Das sind Gerds Geranien! Gerds Geranien, klar? Die werden von niemand anderem angefasst, oder gegossen, oder auch nur angeguckt als Herr Professor Doktor Botanik Meister Gerd Sewering höchstpersönlich! Kapiert?\"\nFrau Harrensen lacht unsicher und sieht zu Papa herüber. Papa nickt ihr wohlwollend zu. Ich weiß auch nicht, was das heißen soll. ",
        "pos":{"x":22.9, "y": 16.4},
    },
    {
        "id":"053",
        "content":"Während Yannis am Waschbecken auf die Sanduhr klopft, spähe ich aus dem Fenster und sehe, dass Mama auf der Schaukel sitzt und weint. Papa legt seine Arme um sie und gibt ihr einen Kuss auf die rot gefärbten Haare. ",
        "pos":{"x":2.5, "y": 19},
    },
    {
        "id":"054",
    ...
    {
        "id":"056",
        "content":"\"Meinst du, ihr kommt heute alleine zurecht? Schaut irgendwas auf dem Fernseher, ich hab Tiefkühlpizza gekauft, die kannst du Yannis und dir warm machen. Ja? ... Ach, ich hol Mama von der Arbeit ab und wir gehen was essen ... Heute war die Urkunde im Briefkasten, weißt du, die für ihre Doktorarbeit.\"",
        "pos":{"x":3.4, "y": 20},
    },
    {
        "id":"057",
